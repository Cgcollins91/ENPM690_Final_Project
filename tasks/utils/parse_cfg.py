# === File Documentation =====================================================
# Path: tasks/utils/parse_cfg.py
# Summary: Implements parse cfg.
# Primary Purpose: Supports task registration and environment configuration, input/config parsing and normalization routines.
...
def load_cfg_from_registry(task_name: str, entry_point_key: str) -> dict | object:
    ...
    .. code-block:: python
        ...
        from tasks.utils.parse_cfg import load_cfg_from_registry
